...
export default function Navbar(props : allItemsRef) {
  ...
  return (
    <header className="  w-8/12 flex flex-col items-center   fixed right-4 2xl:right-10 z-50 ">
      <div className="flex justify-between items-center w-full">
        ...
        <div className=" h-max w-3/12 xl:w-4/12 flex items-center gap-x-6 justify-end  ">
          <button
            onClick={toggleTheme}
          ...
          >
            <svg
              className=" hidden dark:block stroke-2  xl:w-4 xl:h-4 2xl:w-6  2xl:h-6  "
            ...
            <svg
              className=" dark:hidden stroke-2  xl:w-4 xl:h-4 2xl:w-6  2xl:h-6 "
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
