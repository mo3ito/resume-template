  ...
  return (
    <header className="lg:w-8/12 hidden lg:flex flex-col items-center lg:fixed right-4 2xl:right-10 z-50 ">
      <div className="flex justify-between items-center w-full">
        ...
        <div className=" hidden lg:flex h-max  lg:w-4/12  items-center gap-x-6 justify-end  bg-red-200">
          <button
            onClick={toggleTheme}
          ...
          <DefaultButton isLinkTag={true} href={data.telegram} className="  w-40 h-12  2xl:w-44 2xl:h-16" content="Let's Talk">
