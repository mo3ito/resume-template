    ...
    <header className="w-8/12 flex flex-col items-center   fixed right-16 z-50 ">
      <div className="flex justify-between items-center w-full">
        ...
        <div className=" h-max  w-3/12 flex items-center justify-center  ">
          <button
            onClick={toggleTheme}
            className=" flex items-center justify-center  transition-opacity ease-in-out duration-500 [&>*]:theme-mode-icon p-2 rounded-full shadow-md dark:bg-black   size-max -translate-x-10"
          >
            <svg
              className=" hidden dark:block stroke-2 "
            ...
            <svg
              className=" dark:hidden stroke-2 "
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
