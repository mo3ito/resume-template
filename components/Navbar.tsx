    ...
    <header className="w-8/12  flex flex-col items-center text-zinc-800 dark:text-zinc-300 fixed right-16 z-50">
      <div className="flex justify-between items-center w-full">
        <ul className=" flex items-center justify-between text-xl font-bold [&>*]:item-nav   ">
          <li className="border border-red-300">Home</li>
        ...
        <div className=" h-max  w-3/12 flex items-center justify-center  ">
          ...
          <button className=" dark:text-black text-white font-semibold h-16 bg-gradient-to-r from-violet-400 to-violet-700 dark:from-pink-200 dark:to-violet-200 rounded-3xl text-xl w-44 relative" >
            <p className="hover:animation-button-talk">
            let's talk
            <svg className="size-7 inline-block ml-2 pt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6.45455 19L2 22.5V4C2 3.44772 2.44772 3 3 3H21C21.5523 3 22 3.44772 22 4V18C22 18.5523 21.5523 19 21 19H6.45455ZM5.76282 17H20V5H4V18.3851L5.76282 17ZM11 10H13V12H11V10ZM7 10H9V12H7V10ZM15 10H17V12H15V10Z"></path></svg>
            </p>
