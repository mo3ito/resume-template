    ...
    <div className=" h-20 w-full bottom-1 fixed flex justify-center items-center left-0 right-6 lg:hidden">
      <ul className=" dark:bg-[#111111] dark:shadow-md dark:border dark:border-pink-200 bg-purple-700 mx-6 w-96 h-10 z-50 rounded-full flex justify-around items-center shadow-md">
        ...
        <button
            ...
            className=" flex items-center justify-center  transition-opacity ease-in-out duration-500  p-2 rounded-full     size-max "
          >
            <svg
              className=" hidden dark:block dark:fill-zinc-300  stroke-2 size-5  lg:size-4 2xl:size-6   "
            ...
            <svg
              className=" fill-zinc-300 dark:hidden stroke-2 size-5 lg:size-4 2xl:size-6 "
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
