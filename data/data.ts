...
const data = {
  ...
  skills:
    "Html5, Css3, JavaScript, TypeScript, React, Next.js, Tailwindcss, Redux, Node.js, MongoDB, Rest Api, Npm, Git, Responsive Design ,Linux , English",
  yearsExperience: "+2",
  projectDone: "+5",
  ...
  aboutMe:"I graduated with associate degree in Electrical engineering. I worked as a Frontend Developer at Fekrebekr Siraf, a registered company in the Science and Technology Park, specializing in real estate. In addition, I have been involved in other projects, including a startup project called eyeRoll, where I served as an idea developer and a full-stack MERN developer.",
  navBarItems: [
